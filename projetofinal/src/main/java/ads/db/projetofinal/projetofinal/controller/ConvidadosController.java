...
public class ConvidadosController {
    ...
    public boolean creatItemEvento(@CookieValue(value = "cpf", defaultValue = "default") String cpf,
            @PathVariable Integer codigoEvento, @RequestBody Pessoa pessoa) {
    ...
    public boolean deleteItemEvento(@CookieValue(value = "cpf", defaultValue = "default") String cpf,
            @PathVariable Integer codigoEvento, @PathVariable String cpfPessoa) {
    ...
    public boolean confirmarEvento(@CookieValue(value = "cpf", defaultValue = "default") String cpf,
            @PathVariable Integer codigoEvento, @PathVariable String cpfPessoa, @PathVariable Boolean confirmacao) {

        boolean resultado = false;

        if (!cpf.equalsIgnoreCase("default")) {

                resultado = new ConvidadosDAO().update_confirmacao(new Convidado(confirmacao, cpfPessoa, codigoEvento, false));            
    ...
    public boolean confirmarItem(@CookieValue(value = "cpf", defaultValue = "default") String cpf,
            @PathVariable Integer codigoEvento, @PathVariable String cpfPessoa, @PathVariable String nomeItem) {
        ...
        if (!cpf.equalsIgnoreCase("default")) {
            ...
            if (item != null) {
                ...
                resultado = new ConvidadosDAO().update_item(new Convidado(item.getCodigoItem(), cpfPessoa, codigoEvento, false));
